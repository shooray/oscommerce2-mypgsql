...
?>
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="2">
        ...
        <tr>
          <td>PostgreSQL</td>
          <td align="right"><img src="images/<?php echo (extension_loaded('pgsql') ? 'tick.gif' : 'cross.gif'); ?>" border="0" width="16" height="16"></td>
        </tr>
        <tr>
          <td>mbstring</td>
          <td align="right"><img src="images/<?php echo (extension_loaded('mbstring') ? 'tick.gif' : 'cross.gif'); ?>" border="0" width="16" height="16"></td>
        </tr>
      </table>
