  ...
  class d_total_revenue {
    ...
    function getOutput() {
      ...
      if(DB_TYPE == 'mysql') {
        ...
        $orders_query = tep_db_query("select CAST(o.date_purchased AS date) as dateday, sum(ot.value) as total from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_TOTAL . " ot where (CURRENT_DATE - INTERVAL '30 days') <= o.date_purchased and o.orders_id = ot.orders_id and ot.class = 'ot_total' group by dateday");
      }
