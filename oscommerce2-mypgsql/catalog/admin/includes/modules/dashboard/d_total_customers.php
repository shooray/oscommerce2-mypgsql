  ...
  class d_total_customers {
    ...
    function getOutput() {
      ...
      if(DB_TYPE == 'mysql') {
        ...
        $orders_query = tep_db_query("select CAST(customers_info_date_account_created AS date) as dateday, count(*) as total from " . TABLE_CUSTOMERS_INFO . " where (CURRENT_DATE - INTERVAL '30 days') <= customers_info_date_account_created group by dateday");
      }
