  ...
  class d_orders {
    ...
    function getOutput() {
      ...
      if(DB_TYPE == 'mysql') {
        ...
        $orders_query = tep_db_query("select o.orders_id, o.customers_name, greatest(o.date_purchased, coalesce(o.last_modified, '0001-01-01')) as date_last_modified, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_TOTAL . " ot, " . TABLE_ORDERS_STATUS . " s where o.orders_id = ot.orders_id and ot.class = 'ot_total' and o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' order by date_last_modified desc limit 6");
      }
